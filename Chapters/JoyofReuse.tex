...
\begin{itemize}
\item While each project is different and will require its own approach, there are two best practices that should be followed in any shared research repository: a plaintext \hloy{README} file in each project directory and \hloy{a shared naming convention} for files and folders, described below.  
\end{itemize}
